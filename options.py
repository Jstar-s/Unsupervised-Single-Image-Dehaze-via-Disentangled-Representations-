...
class TrainOptions():
  def __init__(self):
    ...
    self.parser.add_argument('--img_save_freq', type=int, default=3, help='freq (epoch) of saving images')
...
class TestOptions():
  def __init__(self):
    ...
    self.parser.add_argument('--crop_size', type=int, default=248, help='cropped image size for training')
